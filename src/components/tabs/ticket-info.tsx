    ...
    <>
      <div className="p-0 pr-0 md:pr-8 pt-8 flex flex-col w-full">
        <div className=" font-normal text-black md:text-white text-left">
          ...
          <aside className={"font-bold pt-4 pr-4"}>
            <p>
              Standard Tickets available at £70.
              <br />
              Golden Circle ticket at £120 per ticket including drink, meet &
              greet and more.
              <a
        ...
        <div className="text-small font-light text-black md:text-white text-left">
          <p>
            Right at the heart of the Baltic Triangle, Camp and Furnace
            encompasses a range of versatile warehouse and studio spaces. Our
            eclectic mix of industrial and rustic character, create a unique and
            unparalleled customer experience, no matter the event.
          </p>
      ...
      <Modal open={hotelOpen} setOpen={setHotelOpen} title={"More Information"}>
        <section className={"text-black text-left"}>
          ...
          <p>
            Why not treat yourself to a Luxury Suite at the Arthouse Hotel,
            Liverpool. This can be booked as an additional extra when you
            purchase your ticket. Our suites sleep between 4 and 14 people,
            priced at between £178 and £992 a night.
          </p>
          ...
          <div className="p-0 grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
            <div>
              <img
                ...
                src="/images/arthouse-luxury-4-sleeper-001.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/arthouse-luxury-4-sleeper-002.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/arthouse-luxury-6-sleeper-001.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/arthouse-luxury-6-sleeper-002.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/arthouse-skyline-001.jpg"
                alt=""
              />
            </div>
            <div>
              <img
                className="h-auto max-w-full rounded-lg"
                src="/images/arthouse-skyline-002.jpg"
                alt=""
              />
            </div>
          </div>
      ...
      <Modal open={open} setOpen={setOpen} title={"More Information"}>
        <section className={"text-black text-left"}></section>
      </Modal>
    </>
  );
};
